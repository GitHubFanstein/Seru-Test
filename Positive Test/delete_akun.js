...
(async function example() {
    ...
    // click button delete akun
      await driver.wait(until.elementLocated(By.xpath(`/html/body/div[2]/div/div/div[2]/div[2]/div[2]/div[3]/div[2]/button`)), 3000);
      const btn_deleteAkun = await driver.findElement(By.xpath(`/html/body/div[2]/div/div/div[2]/div[2]/div[2]/div[3]/div[2]/button`));
      await driver.executeScript("arguments[0].click();", btn_deleteAkun);
      await driver.sleep(2000);
