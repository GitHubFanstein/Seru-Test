...
(async function example() {
  ...
  await driver.sleep(3000);
   ...
   await driver.sleep(5000);
    ...
    // klil menu login
    await driver.wait(until.elementLocated(By.xpath(`/html/body/div[2]/div/div/div[2]/div[1]/div/div/div[6]/div/ul/li[3]`)), 3000);
    const profile = await driver.findElement(By.xpath(`/html/body/div[2]/div/div/div[2]/div[1]/div/div/div[6]/div/ul/li[3]`));
    await driver.executeScript("arguments[0].click();", profile);
    await driver.sleep(3000);

  
      // btn Delet All Books
     await driver.wait(until.elementLocated(By.xpath(`/html/body/div[2]/div/div/div[2]/div[2]/div[2]/div[3]/div[3]/button`)), 3000);
     const btn_deleteallBooks = await driver.findElement(By.xpath(`/html/body/div[2]/div/div/div[2]/div[2]/div[2]/div[3]/div[3]/button`));
     await driver.executeScript("arguments[0].click();", btn_deleteallBooks);
