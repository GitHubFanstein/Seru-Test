...
// Login dengan user yang invalid 
...
(async function example() {
    ...
    try {
      ...
      await driver.findElement(By.id(`userName`)).sendKeys(`SalahUSer`, Key.RETURN);
      await driver.sleep(3000);
  
      // Mengisi Field password
      await driver.wait(until.elementsLocated(By.id(`password`)), 3000);
      await driver.findElement(By.id(`password`)).sendKeys(`@SalahUSer123`, Key.RETURN);
      await driver.sleep(3000);
